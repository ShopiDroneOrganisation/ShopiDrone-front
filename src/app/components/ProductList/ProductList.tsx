      ...
      >
        ...
        >
          <input
            type="text"
            placeholder="Prix"
            onFocus={() => setShowPriceFilter(true)}
            style={{
              padding: "8px",
              borderRadius: "4px",
              border: "1px solid black",
